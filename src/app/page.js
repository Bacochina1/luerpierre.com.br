...
export default function LueurPierrePage() {
  ...
  return (
    <main className="min-h-screen relative bg-[#020202] text-white font-sans overflow-hidden selection:bg-white selection:text-black">
     ...
     <Image src="/logo.png" alt="Logo" width={300} height={100} className="w-[200px] h-auto object-contain" />
      </nav>
      ...
      <div className="fixed inset-0 z-0 mt-16">
        <Image 
          ...
          priority
        />
        {/* Gradiente pesado para garantir leitura e tom dark */}
        <div className="absolute inset-0 bg-gradient-to-r from-black via-[#050505]/90 to-black/20" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center min-h-screen">
        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 animate-[fadeIn_1s_ease-out]">
          ...
          <div className="space-y-6 max-w-3xl">
            ...
            {/* TEXTOS PEQUENOS (Hierarquia Superior) */}
            <div className="flex flex-col gap-2 border-l-0 lg:border-l-2 border-[#702963] pl-0 lg:pl-4">
              ...
              <span className="text-stone-500 text-[10px] tracking-[0.15em] uppercase font-bold">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="space-y-5">
                <div className="group">
                  <input name="name" type="text" required disabled={status === 'loading'} placeholder="Nome Completo" 
                    className="w-full py-3 bg-transparent border-b border-stone-700 text-white placeholder:text-stone-500 focus:border-white focus:outline-none transition-colors font-light text-sm" />
                </div>
              ...
              <div className="flex items-start gap-3 mt-2">
                <input type="checkbox" id="terms" checked={acceptedTerms} onChange={(e) => setAcceptedTerms(e.target.checked)} 
                  className="mt-1 accent-white cursor-pointer bg-transparent border-stone-600" />
                <label htmlFor="terms" className="text-[10px] text-stone-500 cursor-pointer text-left leading-tight hover:text-stone-300 transition-colors">
